...
void BigUnsigned::divideWithRemainder(const BigUnsigned &b, BigUnsigned &q)
{
	...
	//swapnibble
	eosio_assert(this != &q, "BigUnsigned::divideWithRemainder: Cannot write quotient and remainder into the same variable");
	// if (this == &q)
...
{
	eosio::print(bigUnsignedToString(*this).c_str());
}
